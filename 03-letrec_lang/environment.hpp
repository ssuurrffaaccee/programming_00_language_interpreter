...
class Environment : public std::enable_shared_from_this<Environment> {
 public:
  ...
  // std::shared_ptr<Environment> extend_rec(const std::string &proc_name, const
  // std::string& parameter_name,
  //                                     const SPtr<Expression> &body) {
  //   Procedure procedure;
  //   procedure.parameter_ = parameter_name;
  //   procedure.body_ = body;
  //   auto rec_proc_env = this->extend(proc_name,to_value(procedure));
  //   auto procedure_value = rec_proc_env->apply(proc_name);
  //   ProcedureValue* procedure_value_ptr = (ProcedureValue*)
  //   procedure_value.get(); procedure_value_ptr->v_.env_=rec_proc_env; return
  //   rec_proc_env;
  // }
